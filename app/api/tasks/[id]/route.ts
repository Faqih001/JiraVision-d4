...
// GET handler for /api/tasks/[id] - Returns a specific task by ID
...
// PUT handler for /api/tasks/[id] - Updates a specific task
...
// DELETE handler for /api/tasks/[id] - Deletes a specific task
