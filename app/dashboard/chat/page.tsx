            ...
            <div className="divide-y">
              ...
              <button className="w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-muted-foreground truncate">Alice: Let's discuss the API integration</div>
                </div>
              ...
              <button className="w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-muted-foreground truncate">Emily: Sprint planning tomorrow at 10 AM</div>
                </div>
            ...
            <div className="flex flex-col p-4 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="bg-muted/50 rounded-lg p-3 max-w-[80%]">
                  <p>
                    Hello! I'm your AI Scrum Master assistant. I can help you with sprint planning, task management, and
                    team coordination. How can I assist you today?
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="bg-muted/50 rounded-lg p-3 max-w-[80%]">
                  <p>
                    Based on my analysis, Alice is currently assigned to 3 high-priority tasks with a total workload of
                    120% capacity. Here are some suggestions to help balance her workload:
                  </p>
