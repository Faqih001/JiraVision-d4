    ...
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">View and compare team performance metrics</p>
        </div>
        <Button 
          variant="outline" 
          size="sm" 
      ...
      <Card className="flex flex-col items-center justify-center p-12 text-center">
        ...
        <CardDescription className="max-w-md mb-6">
          The comprehensive team leaderboard is currently under development. 
          This feature will allow you to view detailed performance metrics and rankings for all team members.
        </CardDescription>
