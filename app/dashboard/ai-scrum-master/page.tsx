        ...
        <Card className="bg-primary/5 border-primary/20">
          ...
          <CardContent>
            <div className="space-y-4">
              <p>
                Hello team! I've analyzed your current sprint and have some insights to share. Your team is making good
                progress, but there are a few areas that need attention.
              </p>
