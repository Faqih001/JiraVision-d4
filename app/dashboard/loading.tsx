...
import { Loader2, CheckCircle2, BarChart3, Users, Calendar, Sparkles, MessagesSquare } from "lucide-react"
...
export default function Loading() {
  ...
  const [loadingSteps, setLoadingSteps] = useState([
    { name: "Initializing dashboard", complete: false },
    { name: "Loading user data", complete: false },
    { name: "Preparing analytics", complete: false },
    { name: "Setting up workspace", complete: false }
  ])
